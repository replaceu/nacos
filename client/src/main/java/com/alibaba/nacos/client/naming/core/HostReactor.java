...
public class HostReactor implements Closeable {
	 ...
	 * processServiceJson方法将数据转换为ServiceInfo，判断服务信息是否有改变，
	 * 当服务是新注册的，服务有更新、服务有删除，都说明服务被改变了。如果服务改变了，
	 * 则通过消息通知机制告知所有订阅了InstancesChangeEvent事件的订阅者
	...
	public ServiceInfo getServiceInfoDirectlyFromServer(final String serviceName, final String clusters) throws NacosException {
		...
		if (StringUtils.isNotEmpty(result)) { return JacksonUtils.toObj(result, ServiceInfo.class); }
		return null;
	}
