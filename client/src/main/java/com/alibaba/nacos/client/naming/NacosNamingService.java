...
public class NacosNamingService implements NamingService {
	...
	private void initCacheDir(Properties properties) {
		...
		if (!StringUtils.isBlank(jmSnapshotPath)) {
			cacheDir = jmSnapshotPath + File.separator + "nacos" + namingCacheRegistryDir + File.separator + "naming" + File.separator + namespace;
		} else {
			cacheDir = System.getProperty("user.home") + File.separator + "nacos" + namingCacheRegistryDir + File.separator + "naming" + File.separator + namespace;
		}
	}
	...
	public void unsubscribe(String serviceName, String groupName, List<String> clusters, EventListener listener) throws NacosException {
		hostReactor.unSubscribe(NamingUtils.getGroupedName(serviceName, groupName), StringUtils.join(clusters, ","), listener);
	}
